<template>
  <div>
    ...
    <div class="maintext">
      <p class="title">标题测试</p>
      <p class="sale">月销量：0</p>
      <p class="money">￥10/天</p>
      <p class="detail">先帝创业未半而中道崩殂，今天下三分，益州疲弊，此诚危急存亡之秋也。然侍卫之臣不懈于内，忠志之士忘身于外者，盖追先帝之殊遇，欲报之于陛下也。
      ...
      <div class="bottom"><button @click="buynow" class="buybtn">马上下单</button></div>
    </div>
